export const SITE = {
  ...
  hours: [
    ...
    { label: "Sat", value: "8:00 AM - 5:00 PM" },
...
export const SERVICES = [
  {
    ...
    steps: ["Call for price", "We verify condition", "Same-day pickup & cash"],
    why: [
  ...
  },
  {
    ...
    steps: ["Describe converter", "We quote instantly", "Drop-off or we pick up"],
    why: [
  ...
  },
  {
    ...
    steps: ["Send pictures/content", "We confirm offer", "Schedule removal"],
    why: [
  ...
  },
  {
    ...
    steps: ["We assess the load", "We document the weight", "We haul to plant"],
    why: [
...
export const FAQS = [
  {
    ...
    answer:
      "Call now and we can usually dispatch the nearest tow partner within 1-3 hours for Phoenix, Mesa, Tempe, Chandler, Glendale, and Scottsdale. Expedited requests are handled as available.",
    category: "Scheduling",
  },
  {
    question: "Do I have to be with the car during pickup?",
    answer:
      "No. Send us a photo of the title/keys and a quick selfie. We’ll manage the DMV paperwork, secure the tow, and pay you in cash or instant transfer when we haul it.",
    category: "Logistics",
  },
  {
    question: "Any other payment methods?",
    answer:
      "We offer cash, Apple Pay, bank transfer, or Venmo—whatever gets you paid the fastest. The method is confirmed before we arrive so you’re ready.",
    category: "Payment",
  },
  {
    question: "What should I do after the vehicle is towed?",
    answer:
      "Keep the bill of sale we provide, cancel registration with ADOT, and expect a same-day payment confirmation text with your transaction reference.",
    category: "Paperwork",
  },
  {
    question: "Can you pick up cars off the highway?",
    answer:
      "Yes, as long as it’s safe and legal. Our tow partners coordinate with Phoenix PD and ADOT on highway recoveries and debris-free removal.",
    category: "Recovery",
  },
  {
    question: "What if your car is damaged or missing parts?",
    answer:
      "We still buy it. Include the condition details in your quote request and we’ll price it accurately, even if it’s stripped, flooded, or missing panels.",
    category: "Condition",
  },
]
